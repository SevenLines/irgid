...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.task_number'
        db.add_column(u'm_cmsplugin_labs_task', 'task_number',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.task_number'
        db.delete_column(u'm_cmsplugin_labs_task', 'task_number')
